...
inputs = {
    # Module: Network
    aws_subnet_rds__cidr_block                  = "10.0.4.0/24"
    ...
    aws_rds_cluster__final_snapshot_identifier  = "pro-traces-db-snap" # Only alphanumeric characters and hyphens allowed 
    ...
    aws_rds_cluster_instance__instance_class    = "db.t4g.large"
